...
const Arrived = () => {
  ...
  const handleUpdate = (booked_id) => {
    ...
    axios
      .post(
        `${config.apiBaseUrl}backend/ADMIN_PHP/updateNotArrivedBooked.php`,
        formData,
        {
                  ...
                  {filteredPendingData
                    ...
                    .map((data) => (
                      <tr key={data.booked_id}>
                        ...
                        <td>
                          {/* <span style={{ fontSize: "12px" }}>Arrived</span> */}
                          <button
                            style={{
                            ...
                            onClick={() => handleUpdate(data.booked_id)}
                          >
                            {loader
                              ? `${
